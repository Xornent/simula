...
namespace Simula.Scripting.Git
{
    ...
    public static class RepositoryExtensions
    {
        ...
        internal static IEnumerable<ObjectId> Committishes(this Repository repo, object identifier, bool throwIfNotFound = false)
        {
            ...
            if (throwIfNotFound)
            {
                throw new GitException("Unexpected kind of identifier '{0}'.", identifier);
            }
        ...
        /// </summary>
        /// <param name="repository">The <see cref="IRepository"/> being worked with.</param>
        /// <param name="commit">The <see cref="Simula.Scripting.Git.Commit"/> to cherry-pick.</param>
        ...
        /// </summary>
        /// <param name="repository">The <see cref="IRepository"/> being worked with.</param>
        /// <param name="commit">The <see cref="Simula.Scripting.Git.Commit"/> to revert.</param>
