...
namespace Simula.Scripting.Git
{
    ...
    /// </summary>
    [Serializable]
    public class RecurseSubmodulesException : GitException
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.RecurseSubmodulesException"/> class with a serialized data.
        /// </summary>
