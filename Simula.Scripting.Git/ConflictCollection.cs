...
{
    /// <summary>
    ///  The collection of <see cref="Simula.Scripting.Git.Conflict"/>s in a
    ///  <see cref="Simula.Scripting.Git.Repository"/> index due to a
    ...
    public class ConflictCollection : IEnumerable<Conflict>
    {
        ...
        /// <summary>
        ///  Gets the <see cref="Simula.Scripting.Git.Conflict"/> for the
