...
namespace Simula.Scripting.Git.Core
{
    internal class Proxy
    {
        ...
        public static IntPtr git_odb_backend_malloc(IntPtr backend, UIntPtr len)
        {
            ...
            {
                throw new GitException("Unable to allocate {0} bytes; out of memory",
                                                len,
                                                GitErrorCode.Error,
...
#region git_trace_
        ...
        /// <summary>
        /// Install/Enable logging inside of LibGit2 to send messages back to Simula.Scripting.Git.
        ///
...
#region git_libgit2_
    ...
    static class ProxyExtensions
    {
        ...
        public static int ConvertToInt(this UIntPtr input)
        {
            ...
            {
                throw new GitException("value exceeds size of an int");
            }
        ...
        public static long ConvertToLong(this UIntPtr input)
        {
            ...
            {
                throw new GitException("value exceeds size of long");
            }
