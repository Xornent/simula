...
namespace Simula.Scripting.Git.Core
{
    ...
    internal static class Ensure
    {
        ...
        private static readonly Dictionary<GitErrorCode, Func<string, GitErrorCategory, GitException>>
            GitErrorsToGitExceptions =
                new Dictionary<GitErrorCode, Func<string, GitErrorCategory, GitException>>
                {
