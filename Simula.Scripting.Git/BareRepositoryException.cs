...
namespace Simula.Scripting.Git
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.BareRepositoryException"/> class.
        /// </summary>
        public BareRepositoryException()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.BareRepositoryException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.BareRepositoryException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.BareRepositoryException"/> class with a serialized data.
        /// </summary>
