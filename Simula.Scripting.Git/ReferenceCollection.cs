...
namespace Simula.Scripting.Git
{
    ...
    public class ReferenceCollection : IEnumerable<Reference>
    {
        ...
        /// <summary>
        /// Gets the <see cref="Simula.Scripting.Git.Reference"/> with the specified name.
        /// </summary>
        /// <param name="name">The canonical name of the reference to resolve.</param>
        /// <returns>The resolved <see cref="Simula.Scripting.Git.Reference"/> if it has been found, null otherwise.</returns>
            ...
            string logMessage, bool allowOverwrite)
        {
            ...
            if (reference == null)
            {
                throw new GitException("Reference '{0}' doesn't exist. One cannot move a non existing reference.", 
                    currentName);
            }
        ...
        public virtual Reference UpdateTarget(string name, string canonicalRefNameOrObjectish, string logMessage)
        {
            ...
            throw new GitException("Reference '{0}' has an unexpected type ('{1}').",
                                            name,
                                            reference.GetType());
        }
