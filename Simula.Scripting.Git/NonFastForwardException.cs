...
namespace Simula.Scripting.Git
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.NonFastForwardException"/> class.
        /// </summary>
        public NonFastForwardException()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.NonFastForwardException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.NonFastForwardException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.NonFastForwardException"/> class with a serialized data.
        /// </summary>
