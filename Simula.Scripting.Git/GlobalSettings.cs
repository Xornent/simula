...
{
    /// <summary>
    /// Global settings for libgit2 and Simula.Scripting.Git.
    /// </summary>
    public static class GlobalSettings
    {
        ...
        static GlobalSettings()
        {
            ...
            if (netFX)
            {
                ...
                nativeLibraryDefaultPath = Path.Combine(GetExecutingAssemblyDirectory(), "libgit", "win32");
            }
            else
            {
        ...
        /// <summary>
        /// Returns information related to the current Simula.Scripting.Git
        /// library.
        /// </summary>
        ...
        /// information logging information from libgit2 and Simula.Scripting.Git.
        ///
        /// Note that this configuration is global to an entire process
        /// and does not honor application domains.
        /// </summary>
        ...
        public static string NativeLibraryPath
        {
            get
            {
                ...
                {
                    throw new GitException("Querying the native hint path is only supported on .NET Framework and .NET Core platforms");
                }
            ...
            set
            {
                if (!nativeLibraryPathAllowed)
                {
                    throw new GitException("Setting the native hint path is only supported on .NET Framework and .NET Core platforms");
                }

                if (nativeLibraryPathLocked)
                {
                    throw new GitException("You cannot set the native library path after it has been loaded");
                }
                ...
                {
                    throw new GitException(e.Message);
                }
            }
        }
