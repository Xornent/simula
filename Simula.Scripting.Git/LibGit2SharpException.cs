...
namespace Simula.Scripting.Git
{
    ...
    public class GitException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GitException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        public GitException(string format, params object[] args)
            : base(String.Format(CultureInfo.InvariantCulture, format, args))
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="GitException"/> class with a serialized data.
        /// </summary>
