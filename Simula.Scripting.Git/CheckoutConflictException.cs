...
namespace Simula.Scripting.Git
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.CheckoutConflictException"/> class.
        /// </summary>
        public CheckoutConflictException()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.CheckoutConflictException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.CheckoutConflictException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Simula.Scripting.Git.CheckoutConflictException"/> class with a serialized data.
        /// </summary>
