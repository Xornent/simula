...
{
    /// <summary>
    /// Class to translate libgit2 callbacks into delegates exposed by Simula.Scripting.Git.
    /// Handles generating libgit2 git_remote_callbacks datastructure given a set
    /// of Simula.Scripting.Git delegates and handles propagating libgit2 callbacks into
    /// corresponding Simula.Scripting.Git exposed delegates.
    /// </summary>
    internal class RemoteCallbacks
    {
        ...
        /// and calls delegate provided by Simula.Scripting.Git consumer.
        /// </summary>
