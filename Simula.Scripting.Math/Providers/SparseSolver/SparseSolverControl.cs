...
namespace Simula.Maths.Providers.SparseSolver
{
    ...
    {
        const string EnvVarSSProvider = "MathNetMaths.SProvider";
        const string EnvVarSSProviderPath = "MathNetMaths.SProviderPath";
        ...
        /// `MathNetMaths.SProviderPath` or the default probing paths.
        /// </summary>
        ...
        /// "MathNetMaths.SSProvider" environment variable,
