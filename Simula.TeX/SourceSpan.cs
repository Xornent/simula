...
namespace Simula.TeX
{
    public class SourceSpan : IEquatable<SourceSpan>
    {
        ...
        public SourceSpan Segment(int start) => new SourceSpan(SourceName, Source, Start + start, Length - start);
        public SourceSpan Segment(int start, int length) => new SourceSpan(SourceName, Source, Start + start, length);
